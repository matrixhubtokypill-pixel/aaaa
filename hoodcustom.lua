...
if game.PlaceId == 9825515356 then -- hood custom 
...
-- panic above
--=================================================================
-- HOOD CUSTOM SKIN CHANGER (placeId 9825515356)
--=================================================================
do
...
do
    ...
    -- ⚠ Cleanup the Hood Custom Skin Changer (placeId 9825515356)
...
if not Processed then
    ...
    local TriggerBind     = (not isAutoMode) and toKeyCode(K['Triggerbot'] and K['Triggerbot']['Target Bind']) or nil
