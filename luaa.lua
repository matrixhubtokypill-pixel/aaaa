...
do
    ...
    -- Silent Aim status - COMBINED into one text
    ...
    do
        ...
        function Script:Triggerbot()
            ...
            -- Use SAME targeting mode as Silent Aim
            ...
            if targetingMode == 'Auto' then
                ...
                -- TriggerbotTarget is set via keybind in InputBegan
            end
            ...
            -- Check conditions (same checks as Silent Aim)
            local Conditions = getgenv().saved.Osiris['General']['Checks']
            ...
            -- Check if cursor is on target and trigger is active
