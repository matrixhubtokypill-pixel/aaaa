...
local function checkForWallHop()
    ...
    for _, dir in ipairs(directions) do
        ...
        if result then
            ...
            if math.abs(normal.Y) < WallHopOsiris.WallNormalThreshold then return true, normal end
        end
    end
    return false, nil
end
...
UserInputService.InputBegan:Connect(function(input, gameProcessed)
    ...
    if input.KeyCode == Enum.KeyCode.Space and WallHopEnabled then performWallHop() end
end)
RunService.Heartbeat:Connect(function()
    local char, hum, root = getCharacter()
