...
-- library functions 
	...
	-- elements 
		...
		function library:window(properties)
			...
			-- cfg holder (shortened width)
				local holder = library:panel({
					name = "Configurations", 
					size = dim2(0, 324, 0, 410), -- Shortened from 324 to 268
			...
			-- ESP Preview removed completely
			-- Playerlist removed completely
		...
		-- ESP Preview function removed
		-- Playerlist function removed

		-- Removed esp_preview and playerlist functions entirely
	-- 
-- 
